...
game::game(int wid, int height) :wid(wid), height(height) {
	...
	px = 40;
	ving.resize(3);
	loadimage(&ving[0], L"C:\\Users\\周睿洋\\Desktop\\编程\\项目\\GameOS\\images\\2.jpg", px, px);
	loadimage(&ving[1], L"C:\\Users\\周睿洋\\Desktop\\编程\\项目\\GameOS\\images\\3.jpg", px, px);
	loadimage(&ving[2], L"C:\\Users\\周睿洋\\Desktop\\编程\\项目\\GameOS\\images\\1.jpg", px, px);
	grade = 0;
